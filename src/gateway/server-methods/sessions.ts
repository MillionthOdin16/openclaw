...
export const sessionsHandlers: GatewayRequestHandlers = {
  ...
  "sessions.preview": ({ params, respond }) => {
    ...
    for (const key of keys) {
      try {
        ...
        // ⚡ Bolt: Use loop instead of array map/find to avoid intermediate allocations and evaluate lazily
  ...
  "sessions.get": ({ params, respond }) => {
    ...
    // ⚡ Bolt: Early return loop avoids unnecessary array mapping and allocations
    let entry: SessionEntry | undefined;
