...
const TIMEOUT_HINT_RE =
  /timeout|timed out|deadline exceeded|context deadline exceeded|stop reason:\s*abort|reason:\s*abort|unhandled stop reason:\s*abort|stop reason:\s*network_error|reason:\s*network_error|unhandled stop reason:\s*network_error|connection error|network error|socket hang up|connection reset/i;
