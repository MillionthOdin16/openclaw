...
(() => {
  ...
  fragment.appendChild(document.createTextNode("Bridge: "));
  fragment.appendChild(bridgeSpan);
  fragment.appendChild(document.createTextNode(" · iOS=" + (hasIOS() ? "yes" : "no") + " · Android=" + (hasAndroid() ? "yes" : "no")));
