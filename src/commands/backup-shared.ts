...
export async function resolveBackupPlanFromDisk(
  ...
  // Optimization: Sort candidates in place to avoid intermediate array allocations
  ...
  // Optimization: Combine deduplication and inclusion logic into a single-pass loop
