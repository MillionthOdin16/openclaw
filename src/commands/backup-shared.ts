...
export async function resolveBackupPlanFromDisk(
  ...
  // ⚡ Bolt Performance Optimization: Sort locally-scoped candidates array
  // in-place and iterate single-pass to populate both skipped and included arrays.
  // This avoids intermediate array allocation from `[...candidates].toSorted()`
  // and the temporary `uniqueCandidates` array overhead.
