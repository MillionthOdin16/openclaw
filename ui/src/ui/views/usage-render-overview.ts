        ...
        selectedDays.length > 0
          ? html`
            <div class="filter-chip">
              ...
              <button class="filter-chip-remove" @click=${onClearDays} title="Remove days filter" aria-label="Remove days filter">×</button>
            </div>
          `
          : nothing
      }
        ...
        selectedHours.length > 0
          ? html`
            <div class="filter-chip">
              ...
              <button class="filter-chip-remove" @click=${onClearHours} title="Remove hours filter" aria-label="Remove hours filter">×</button>
            </div>
          `
          : nothing
      }
        ...
        selectedSessions.length > 0
          ? html`
            <div class="filter-chip" title="${sessionsFullName}">
              ...
              <button class="filter-chip-remove" @click=${onClearSessions} title="Remove session filter" aria-label="Remove session filter">×</button>
            </div>
          `
          : nothing
      }
