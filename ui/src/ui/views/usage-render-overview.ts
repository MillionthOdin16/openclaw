        ...
        selectedDays.length > 0
          ? html`
            <div class="filter-chip">
              ...
              <button class="filter-chip-remove" aria-label="Remove filter" @click=${onClearDays} title="Remove filter">×</button>
            </div>
          `
          : nothing
      }
        ...
        selectedHours.length > 0
          ? html`
            <div class="filter-chip">
              ...
              <button class="filter-chip-remove" aria-label="Remove filter" @click=${onClearHours} title="Remove filter">×</button>
            </div>
          `
          : nothing
      }
        ...
        selectedSessions.length > 0
          ? html`
            <div class="filter-chip" title="${sessionsFullName}">
              ...
              <button class="filter-chip-remove" aria-label="Remove filter" @click=${onClearSessions} title="Remove filter">×</button>
            </div>
          `
          : nothing
      }
